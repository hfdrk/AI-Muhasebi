export type RiskAlertType = "RISK_THRESHOLD_EXCEEDED" | "ANOMALY_DETECTED" | "ML_FRAUD_DETECTION" | "INVOICE_DUPLICATE" | "FRAUD_PATTERN" | "UNUSUAL_COUNTERPARTY" | "CHART_MISMATCH";
