...
export interface UsageSummary {
  clientCompanies: { used: number; limit: number; remaining: number };
  documents: { used: number; limit: number; remaining: number };
  aiAnalyses: { used: number; limit: number; remaining: number };
  users: { used: number; limit: number; remaining: number };
  scheduledReports: { used: number; limit: number; remaining: number };
}
