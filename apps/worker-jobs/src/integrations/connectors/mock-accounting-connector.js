...
exports.MockAccountingConnector = void 0;
class MockAccountingConnector {
    ...
    async fetchInvoices(sinceDate, untilDate, options) {
        const mockInvoices = [
            {
        ...
        return mockInvoices.filter((inv) => inv.issueDate >= sinceDate && inv.issueDate <= untilDate);
    }
}
exports.MockAccountingConnector = MockAccountingConnector;
//# sourceMappingURL=mock-accounting-connector.js.map