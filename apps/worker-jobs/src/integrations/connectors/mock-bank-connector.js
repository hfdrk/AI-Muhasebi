...
exports.MockBankConnector = void 0;
class MockBankConnector {
    ...
    async fetchTransactions(sinceDate, untilDate, options) {
        ...
        let filtered = mockTransactions.filter((txn) => txn.bookingDate >= sinceDate && txn.bookingDate <= untilDate);
...
exports.MockBankConnector = MockBankConnector;
//# sourceMappingURL=mock-bank-connector.js.map