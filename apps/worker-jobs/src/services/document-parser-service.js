...
class DocumentParserService {
     ...
     */
    async parseDocument(rawText, documentTypeHint, tenantId) {
    ...
    parseInvoice(text) {
        ...
        const invoiceNumberMatch = text.match(/Fatura\s*(?:No|No\.|Numarası|Numara)[\s:]*([A-Z0-9\-]+)/i);
